...
<div class="col-lg-16">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(route('add.plan.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" rows="6"><?php echo e(old('des')); ?></textarea>
                        <?php $__errorArgs = ['des'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" rows="6"><?php echo e(old('des_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="7"><?php echo e(old('service')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="7"><?php echo e(old('service_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="2"><?php echo e(old('hint')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="2"><?php echo e(old('hint_en')); ?></textarea>
...
<?php echo $__env->make('admin.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/planne/add_planne.blade.php ENDPATH**/ ?>