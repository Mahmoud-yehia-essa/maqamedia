                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="<?php echo e(route('add.category.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="category_description" class="form-control" value="<?php echo e(old('category_description')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="<?php echo e(url('upload/no_image.jpg')); ?>" alt="Preview" style="width:100px; height: 100px;">
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/category/add_category.blade.php ENDPATH**/ ?>