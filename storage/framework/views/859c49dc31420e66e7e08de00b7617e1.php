...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(route('edit.service.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('title', $value->title)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('title_en', $value->title_en)); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('des', $value->des)); ?></textarea>
                        <?php $__errorArgs = ['des'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('des_en', $value->des_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <img id="showImage" src="<?php echo e((!empty($value->photo) && $value->photo != 'non') ? url($value->photo) : url('upload/no_image.jpg')); ?>" alt="Preview" width="110">
                    </div>
                </div>
...
<?php echo $__env->make('admin.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/service/edit_service.blade.php ENDPATH**/ ?>