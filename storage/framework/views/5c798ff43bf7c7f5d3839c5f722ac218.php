            ...
            <div class="col-lg-10">
                <div class="service-card shadow rounded" style="background: #fff; padding: 50px; margin-bottom: 50px;">
                    ...
                    <div class="text-center mb-5">
                        <img src="<?php echo e(asset($service->photo)); ?>" alt="<?php echo e($service->title); ?>"
...
<?php echo $__env->make('frontend.master_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/frontend/pages/service_single.blade.php ENDPATH**/ ?>