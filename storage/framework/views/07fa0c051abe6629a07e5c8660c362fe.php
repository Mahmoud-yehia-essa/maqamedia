...
<div class="col-lg-9">
    ...
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0" style="color: white">المحادثة مع <?php echo e($service->user->fname); ?> بخصوص  <?php echo e($service->service->title); ?></h5>
        </div>
            ...
            <div class="row mb-2">
                <div class="col-md-6 mb-2">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <span><?php echo e($service->service->title ?? '-'); ?></span>
                    </div>
                </div>
                <div class="col-md-6 mb-2">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <?php elseif($service->status == 'working'): ?>
                ...
                <div class="col-md-6 mb-2">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <span><?php echo e($service->created_at->format('d/m/Y H:i') ?? '-'); ?></span>
                    </div>
                </div>
                <div class="col-md-6 mb-2">
                    <div class="p-3 border rounded bg-light">
                        <strong>آخر تعديل على الطلب:</strong>
                        <span><?php echo e($service->updated_at->diffForHumans() ?? '-'); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    function renderMessage(msg) {
        ...
        var isCurrentUser = msg.user_id === <?php echo e(Auth::id()); ?>;
        var html = '';
    ...
    // Initial fetch
    $.get("/admin/messages/fetch/" + $('#service_id').val(), function(data){
    ...
    setInterval(function(){
        ...
        $.get("/admin/messages/fetch/" + service_id, function(data) {
            data.forEach(function(msg){
    ...
    $('#chatForm').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('add.admin.messages.ajax')); ?>",
            method: "POST",
...
<?php echo $__env->make('admin.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/user_service/chat_user_service.blade.php ENDPATH**/ ?>