...
<div class="container">
    <div class="main-body">
        <div class="row">
            <div class="col-lg-8">
                <form action="<?php echo e(route('add.user.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="fname" type="text" class="form-control" value="<?php echo e(old('fname')); ?>" />
...
<div class="row mb-3">
    ...
    <?php $__currentLoopData = $countryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e(json_encode(['dial' => $country['dial'], 'code' => $country['code'],'name' => $country['name'], 'flag' => $country['flag']])); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="email" autocomplete="off" type="email" class="form-control" value="<?php echo e(old('email')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="<?php echo e(url('upload/no_image.jpg')); ?>" alt="Admin" width="110">
                                </div>
                            </div>
...
<?php echo $__env->make('admin.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/users/add_user.blade.php ENDPATH**/ ?>