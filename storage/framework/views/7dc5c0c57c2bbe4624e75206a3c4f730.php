...
<div class="about-header-area" style="background-image: url(<?php echo e(asset('frontend/assets/img/bg/inner-header.png')); ?>); background-repeat: no-repeat; background-size: cover; background-position: center;">
    <div class="container text-center">
        <h2 style="color: white">تفاصيل الخطة</h2>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-8 m-auto">
            <div class="card shadow-lg p-4 rounded-3">
                ...
                <!-- عنوان -->
                <h3 class="mb-3"><?php echo e($plan->title); ?></h3>
...
<?php echo $__env->make('frontend.master_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/frontend/pages/planne_all.blade.php ENDPATH**/ ?>