        ...
        <nav class="navbar navbar-expand gap-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="header-notifications-list">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="<?php echo e(asset('backend/assets/images/avatars/avatar-4.png')); ?>" class="msg-avatar" alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e((!empty(Auth()->user()->photo)) ? url('upload/admin_images/'.Auth()->user()->photo):url('upload/no_image.jpg')); ?>" class="user-img" alt="user avatar">
                    <div class="user-info">
                        <p class="user-name mb-0"><?php echo e(Auth()->user()->fname); ?></p>
                        <p class="designattion mb-0"><?php echo e(Auth()->user()->email); ?></p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a  class="dropdown-item d-flex align-items-center" href="<?php echo e(route('admin.profile')); ?>"><i class="bx bx-user fs-5"></i><span>الملف الشخصي</span></a>
                    </li>
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.change.password')); ?>"><i class="bx bx-cog"></i><span>تعديل كلمة المرور</span></a>
                    </li>
                    ...
                    <li><a href="<?php echo e(route('admin.logout')); ?>" class="dropdown-item d-flex align-items-center" href="javascript:;"><i class="bx bx-log-out-circle"></i><span>تسجيل الخروج</span></a>
                    </li>
                </ul>
            </div>
        </nav>
...
<?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/include/header.blade.php ENDPATH**/ ?>