          ...
          <div class="row">
            <div class="col-12 text-center">
                <div class="project15-header heading23">
                    ...
                    <h3 style="font-family: 'Cairo', sans-serif; font-weight: 700; color: #ED7032; margin-bottom: 10px;"> <?php echo e($home[3]->title); ?></h3>
            ...
            <?php $__currentLoopData = $companywork; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 col-12 mb-4 d-flex" data-aos="zoom-in" data-aos-duration="800">
                    <div class="project15-boxarea d-flex flex-column" style="width:100%;">
                        <!-- Image -->
                        <a href="<?php echo e(route('show.portfolio.details',$item->id)); ?>">
                            <div class="img1" style="width:100%;">
                                <img src="<?php echo e($item->photo); ?>" alt="" style="width:100%; height:250px; object-fit:cover; display:block;">
                            </div>
                        </a>
                        ...
                        <!-- Text Area -->
                        <div class="text-area">
                            <a class="h5 d-block mb-2"><?php echo e($item->title); ?></a>
                            <p style="
                                display: -webkit-box;
                                -webkit-line-clamp: 3;
...
<?php echo $__env->make('frontend.master_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/frontend/pages/portfolio.blade.php ENDPATH**/ ?>