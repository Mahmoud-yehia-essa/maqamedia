...
<div class="col-lg-9">
    ...
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">المحادثة مع الادارة بخصوص <?php echo e($service->service->title); ?></h5>
        </div>
...
$(document).ready(function() {
    ...
    $('#chatForm').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('add.user.messages.ajax')); ?>",
            method: "POST",
...
<?php echo $__env->make('frontend.pages.user.user_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/frontend/pages/user/chat_dashboard.blade.php ENDPATH**/ ?>