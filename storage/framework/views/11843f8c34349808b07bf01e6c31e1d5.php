...
<div class="col-lg-16">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(route('add.work.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               name="title_en" value="<?php echo e(old('title_en')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                  id="input11" placeholder="الوصف ..." rows="3"><?php echo e(old('des')); ?></textarea>
                        <?php $__errorArgs = ['des'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                  id="input11" placeholder="Description ..." rows="3"><?php echo e(old('des_en')); ?></textarea>
...
<?php echo $__env->make('admin.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/admin/company_work/add_company_work.blade.php ENDPATH**/ ?>