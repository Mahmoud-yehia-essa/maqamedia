        ...
        <div class="row">
            <div class="col-lg-6 m-auto text-center">
                <div class="about-inner-header heading9">
                    <h1 style="font-family: 'Cairo', sans-serif; color:white; font-weight:700;"><?php echo e($gallery->title); ?></h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="gallery-slider py-5">
    <div class="container">
        ...
        <div class="swiper main-swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide d-flex justify-content-center align-items-center" style="height:400px;">
                    <img src="<?php echo e(url($photo->photo)); ?>" alt="Gallery Image" class="img-fluid rounded"
                         style="max-height:100%; max-width:100%; object-fit: contain; cursor:pointer;"
                         onclick="openModal('<?php echo e(url($photo->photo)); ?>')">
                </div>
        ...
        <div class="swiper thumb-swiper mt-3">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" style="width:80px; cursor:pointer;">
                    <img src="<?php echo e(url($photo->photo)); ?>" alt="Thumb" style="width:100%; height:60px; object-fit: cover; border-radius:5px;">
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="mt-4 text-center">
            <h3 style="font-family: 'Cairo'"><?php echo e($gallery->title); ?></h3>
            <br>
            <p
...
<?php echo $__env->make('frontend.master_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/KINGSTON/Almaqam/cpanel/resources/views/frontend/pages/gallery_details.blade.php ENDPATH**/ ?>