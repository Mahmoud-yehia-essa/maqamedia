...
<div class="col-lg-16">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('edit.plan.store') }}">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $value->title) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" name="title_en" class="form-control @error('title_en') is-invalid @enderror" value="{{ old('title_en', $value->title_en) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea name="service" class="form-control @error('service') is-invalid @enderror" rows="7">{{ old('service', $value->service) }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea name="service_en" class="form-control @error('service_en') is-invalid @enderror" rows="7">{{ old('service_en', $value->service_en) }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea name="hint" class="form-control @error('hint') is-invalid @enderror" rows="2">{{ old('hint', $value->hint) }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea name="hint_en" class="form-control @error('hint_en') is-invalid @enderror" rows="2">{{ old('hint_en', $value->hint_en) }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="number" step="0.01" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $value->price) }}">
                    ...
                    <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <option  value="no" {{$value->is_suggest === 'no' ? 'selected' : ''}}>لا</option>

                                         <option value="yes" {{$value->is_suggest === 'yes' ? 'selected' : ''}}>نعم</option>
