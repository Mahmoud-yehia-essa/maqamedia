...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('add.company_client.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea class="form-control" name="des" rows="3">{{ old('des') }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea class="form-control" name="des_en" rows="3">{{ old('des_en') }}</textarea>
