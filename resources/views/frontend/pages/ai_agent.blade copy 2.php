...
<script>
    ...
    function sendMessage(event) {
        ...
        .then(data => {
            ...
            // معالجة JSON بشكل صحيح لتجنب [object Object]
            let answerText = "";
            if(data.answer){
                if(typeof data.answer === "object"){
                    // إذا كان من API Gemini
                    if(data.answer.candidates && data.answer.candidates[0].content){
                        answerText = data.answer.candidates[0].content;
                    } else {
