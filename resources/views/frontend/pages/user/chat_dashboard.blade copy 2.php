...
$(document).ready(function() {
    var chatBox = $('#chatBox');
    var lastMessageId = 0; // آخر رسالة تم عرضها
            ...
            return `<div class="d-flex mb-4">
                        <div class="me-3">
                            <div class="rounded-circle bg-success text-white d-flex align-items-center justify-content-center"
                                 style="width:45px; height:45px; font-size:18px;">${userInitial}</div>
                        </div>
    ...
    // جلب الرسائل الجديدة كل 2 ثانية
