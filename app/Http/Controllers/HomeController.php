  ...
  public function allHome()
    {
        ...
        return view('admin.home.home_all',compact('home'));
    }
    ...
    // }
       ...
       public function editHomeStore(Request $request){
...
$request->validate([
    ...
    // 'photo'     => $save_url,
      ...
      public function homeInactive($id){
        Home::findOrFail($id)->update(['status' => 'inactive']);
        $notification = array(
            'message' => ' غير مفعل',
            'alert-type' => 'success'
        );
      ...
      public function homeActive($id){
        Home::findOrFail($id)->update(['status' => 'active']);
        $notification = array(
            'message' => 'مفعل',
            'alert-type' => 'success'
        );
